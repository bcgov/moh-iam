                ...
                <ul class="${properties.kcFormSocialAccountListClass!}">
                    ...
                    <#list social.providers as p>	
                        <#if p.displayName?contains("outage")>
                            <li class="${properties.kcFormSocialAccountListLinkClass!} idp-outage"><a style="display: block;" href="${p.loginUrl}" id="zocial-${p.alias}" class="zocial ${p.providerId}"> <span>Login with ${p.displayName?remove_ending("outage")} is currently unavailable. IDP team is working on restoring the service.</span></a></li>
                        <#else>
